...
#define TRC_CFG_ENABLE_STACK_MONITOR            0    // <- Vous essaierez ça plus tard...
#define TRC_CFG_STACK_MONITOR_MAX_TASKS         10
#define TRC_CFG_STACK_MONITOR_MAX_REPORTS       0

#define TRC_CFG_CTRL_TASK_PRIORITY              1    // <- Il peut être utile de régler ça
#define TRC_CFG_CTRL_TASK_DELAY                 10   // <- et ça aussi...
